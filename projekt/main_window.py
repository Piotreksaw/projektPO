...
class MainWindow(QWidget):
    ...
    def __prepare_window(self):
        ...
        self.__buttons2 = Export_and_something_buttons(self.__chart)
        ...
        # Moze warto byloby dodac jakis warunek ktory sprawdzi czy plik jest wgrany przed dodaniem przyciskow?
